...
open_to     : Full-time DevOps / Cloud Engineer opportunities 💼
motto       : "Automate first, manual never!"
```
...
|-----------|---------------|---------|
| 🏗️ [Azure IaC with Terraform](#) | Automated provisioning of AKS, VNets, VMs on Azure | Terraform, Azure, Bash |
| 🚀 [CI/CD Pipeline](#) | End-to-end pipeline for containerized app deployment | GitHub Actions, Docker, AKS |
| ☸️ [Kubernetes on AKS](#) | Production-grade AKS setup with Helm & monitoring | Kubernetes, Helm, Prometheus |
| 📊 [Azure Monitoring Stack](#) | Centralized monitoring with alerts & dashboards | Azure Monitor, Grafana |
| 🔐 [Azure RBAC Automation](#) | PowerShell scripts for RBAC & Key Vault management | PowerShell, Azure AD |
